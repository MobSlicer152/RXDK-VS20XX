...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pSphereMapTexture = m_xprResource.GetTexture( "XRay1" );

    // Load the object
    if( FAILED( m_pObject->Create( "Models\\Robot.xbg", &m_xprResource ) ) )
        return XBAPPERR_MEDIANOTFOUND;
...
HRESULT CXBoxSample::Render()
{
    ...
    m_pObject->Render( XBMESH_NOTEXTURES|XBMESH_NOMATERIALS );
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"XRay" );
