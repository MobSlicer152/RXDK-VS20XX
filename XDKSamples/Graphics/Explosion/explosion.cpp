...
{
public:
    CExplosion( LPDIRECT3DDEVICE8 pDevice, LPDIRECT3DTEXTURE8 pExplosionImage, 
                LPDIRECT3DTEXTURE8 pExplosionDepth, D3DXVECTOR3 vCenter,
                FLOAT fMaxRadius, FLOAT fDuration );
    ~CExplosion();
    HRESULT Render();
...
HRESULT CExplosion::InitVertexShader()
{
    ...
    XBUtil_CreateVertexShader( "shaders\\zsprite.xvu", dwDecl, &m_dwVertexShader );
...
//-----------------------------------------------------------------------------
// Name: Initialize()
// Desc: Performs initializationtion
//-----------------------------------------------------------------------------
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pGroundTex = m_xprResource.GetTexture( "Ground" );
    m_pExp[0]    = m_xprResource.GetTexture( "exp1" );
    m_pExpD[0]   = m_xprResource.GetTexture( "exp1d" );
    m_pExp[1]    = m_xprResource.GetTexture( "exp2" );
    m_pExpD[1]   = m_xprResource.GetTexture( "exp2d" );
    m_pExp[2]    = m_xprResource.GetTexture( "exp3" );
    m_pExpD[2]   = m_xprResource.GetTexture( "exp3d" );

    // Create our terrain
    m_Terrain.Initialize( m_pd3dDevice );
    m_Terrain.Generate( 12, 12, D3DXVECTOR2( -10.0f, -10.0f ),
                        D3DXVECTOR2( 10.0f, 10.0f ), m_pGroundTex, fHeightFn );
...
HRESULT CXBoxSample::Render()
{
    ...
    // Set state for rendering explosions
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"Explosion" );
...
//-----------------------------------------------------------------------------
CExplosion::CExplosion( LPDIRECT3DDEVICE8 pDevice, LPDIRECT3DTEXTURE8 pExplosionImage, 
                        LPDIRECT3DTEXTURE8 pExplosionDepth, D3DXVECTOR3 vCenter,
                        FLOAT fMaxRadius, FLOAT fDuration )
{
