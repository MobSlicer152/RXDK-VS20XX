...
//       09.19.02 - Added use of D3DTSS_COLORSIGN
//
...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pBackgroundTexture = m_xprResource.GetTexture( "Lake" );
...
HRESULT CXBoxSample::Render()
{
    ...
    m_pd3dDevice->SetTextureStageState( 0, D3DTSS_COLORSIGN, D3DTSIGN_RSIGNED|D3DTSIGN_GSIGNED|D3DTSIGN_BSIGNED );
    m_pd3dDevice->SetTextureStageState( 0, D3DTSS_MINFILTER, D3DTEXF_LINEAR );
    m_pd3dDevice->SetTextureStageState( 0, D3DTSS_MAGFILTER, D3DTEXF_LINEAR );
    ...
    m_Font.DrawText( 48, 36, 0xffffffff,  L"BumpLens" );
