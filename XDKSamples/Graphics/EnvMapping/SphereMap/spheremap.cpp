...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pSphereMapTexture = m_xprResource.GetTexture( "SphMap1" );

    // Load the teapot object
    if( FAILED( m_pTeapot->Create( "Models\\Teapot.xbg", &m_xprResource ) ) )
        return XBAPPERR_MEDIANOTFOUND;
...
HRESULT CXBoxSample::Render()
{
    ...
    m_pTeapot->Render( XBMESH_NOTEXTURES );
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"SphereMap" );
