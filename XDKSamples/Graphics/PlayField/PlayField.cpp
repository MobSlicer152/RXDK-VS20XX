...
XBHELP_CALLOUT g_HelpCallouts[] = 
{
    ...
    { XBHELP_MISC_CALLOUT, XBHELP_PLACEMENT_1, L"Use triggers to adjust height" },
...
//       such as chalk lines or dirt patches. The alpha channel of the
...
HRESULT GetTerrainColors( const D3DXVECTOR3 &vPosition, D3DCOLOR *rColor,
                          float *pfXFraction, float *pfZFraction )
{
...
//-----------------------------------------------------------------------------
HRESULT MarkTerrain( const D3DXVECTOR3 &vPosition, const D3DXCOLOR &colorScale, 
                     const D3DXCOLOR &colorOffset, const D3DXCOLOR &colorMin, 
...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pFieldGrassTexture = m_xprResources.GetTexture( "Grass" );
    m_pGrassStripTexture = m_xprResources.GetTexture( "GrassStrip" );
...
{ 
    ...
    m_pFieldTexture = m_xprResources.GetTexture( g_strFieldTextureNames[m_iCurrentFieldTexture] );
...
//-----------------------------------------------------------------------------
HRESULT CXBoxSample::FillFieldVertexBuffer()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CXBoxSample::FillGrassVertexBuffer()
{
    HRESULT hr;
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"PlayField" );
