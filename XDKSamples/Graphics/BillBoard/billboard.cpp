...
//       technique is the same, but the billboards are positioned slightly
...
HRESULT CXBoxSample::Initialize()
{
    ...
    // Load the terrain
    if( FAILED( m_TerrainObject.Create( "Models\\Hillside.xbg", &m_xprResource  ) ) )
        return XBAPPERR_MEDIANOTFOUND;
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Billbrd.xvu",
...
HRESULT CXBoxSample::FrameMove()
{
    ...
    D3DXMatrixLookAtLH( &matView, &g_vEyePt, &vLookatPt, &vUp );
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"BillBoard" );
