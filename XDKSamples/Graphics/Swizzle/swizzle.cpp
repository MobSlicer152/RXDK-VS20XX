...
XBHELP_CALLOUT g_HelpCallouts[] = 
{
    ...
    { XBHELP_A_BUTTON,     XBHELP_PLACEMENT_2, L"Lock every\nframe" },
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"Swizzle" );
        ...
        switch( m_d3dFormat )
        {
            ...
            case D3DFMT_LIN_A8R8G8B8: m_Font.DrawText( 275, 100, 0xffffff00, L"D3DFMT_LIN_A8R8G8B8" ); break;
        }

        m_Font.DrawText(  64, 125, 0xffffffff, L"Update every frame:" );
        m_Font.DrawText( 275, 125, 0xffffff00, m_bUpdateEveryFrame ? L"TRUE" : L"FALSE" );
        ...
        if( m_bUpdateEveryFrame )
        {
            if( XGIsSwizzledFormat( m_d3dFormat ) )
            {
                ...
                m_Font.DrawText( 275, 150, 0xffffff00, m_bUseSwizzlerClass ? L"TRUE" : L"FALSE" );

                m_Font.DrawText(  64, 175, 0xffffffff, L"Using swizzler API:" );
                m_Font.DrawText( 275, 175, 0xffffff00, m_bUseSwizzlerAPI ? L"TRUE" : L"FALSE" );
            }
        }
