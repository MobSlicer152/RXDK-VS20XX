...
HRESULT CXBoxSample::FrameMove()
{
    ...
    const D3DXVECTOR3 vLookAt( g_vFlashLightPos + g_vFlashLightDir );
    const D3DXVECTOR3 vUp    ( 0.0f, 1.0f, 0.0f );
    D3DXMATRIX matLookAt;
    D3DXMatrixLookAtLH( &matLookAt, &g_vFlashLightPos, &vLookAt, &vUp );
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"VolumeLight" );
