...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_pTexture2 = m_xprResource.GetTexture( "Checker" );
    ...
    {
        OUTPUT_DEBUG_STRING( "Could not create hard coded pixel shader.\n" );
        return E_FAIL;
    }

    // Create a file-based pixel shader. This shader uses the diffuse value to
    ...
    //      mov r1, t1
    //      lrp r0, v0, t0, r1
    if( FAILED( XBUtil_CreatePixelShader( "D:\\Media\\Shaders\\PShader.xpu",
                                          &m_dwPixelShader2 ) ) )
    {
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"PixelShader" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );
        m_Font.DrawText( 592, 38, 0xffffff00, m_strFrameRate, XBFONT_RIGHT );

        if( m_bHardcodedShader )
        {
            m_Font.DrawText( 64,  75, 0xffffffff, L"Using hard-coded shader" );
            m_Font.DrawText( 64, 100, 0xffffffff, L"Output is:" );
            m_Font.DrawText( 64, 125, 0xffffff00, L"   v0 * (t2.a > 0.5 ? t0 : t1 )" );
            m_Font.DrawText( 64, 150, 0xffffffff, L"Where:" );
        ...
        {
            m_Font.DrawText( 64,  75, 0xffffffff, L"Using file-based shader" );
            m_Font.DrawText( 64, 100, 0xffffffff, L"Output is:" );
