...
HRESULT CXBoxSample::Initialize()
{
    ...
    // Create the geometry for the fuzz
...
HRESULT CXBoxSample::FrameMove()
{
    ...
    D3DXMATRIX matView;
    D3DXMatrixLookAtLH( &matView, &vEyePt, &vZero, &vUp );
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"FuzzyTeapot" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );
        m_Font.DrawText( 592, 38, 0xffffff00, m_strFrameRate, XBFONT_RIGHT );

        WCHAR str[40];
        swprintf( str, L"%d", m_dwNumFuzzLayers );
        m_Font.DrawText( 64, 70, 0xffffffff, L"Fuzz Layers: " );
