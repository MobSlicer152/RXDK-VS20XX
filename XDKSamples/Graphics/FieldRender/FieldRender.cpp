...
//       a 60 Hz presentation interval is used to alternate between alternate
//       fields displaying odd and even buffers that are 640x240 in size. This
//       is specified in the device creation parameters. The only additional step
...
//       that precede the few actual changes.
//
            ...
            :CXBApplication()
{
    ...
    // rendering. The refresh rate should be left at its default, and, since
...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_Font.SetScaleFactors( 1.0f, 0.5f );
...
HRESULT CXBoxSample::FrameMove()
{
    ...
    D3DXMatrixLookAtLH( &matPathLookAt, &vLookAt, &vDolphinDir, &vUp );
    ...
    // Render the dolphin's shadow
    {
        ...
        D3DXVECTOR4 fLocalFog = D3DXVECTOR4( 0.5f, 0.1f, 0.0f, 0.0f );
...
HRESULT CXBoxSample::Render()
{
    ...
    m_Font.Begin();
    m_Font.SetScaleFactors( 1.2f, 1.2f / 2 );
    m_Font.DrawText( 48, 36 / 2, 0xffffffff, L"Dolphin" );
    m_Font.SetScaleFactors( 1.0f, 1.0f / 2 );
    m_Font.DrawText( 592, 38 / 2, 0xffffff00, m_strFrameRate, XBFONT_RIGHT );
    m_Font.End();
