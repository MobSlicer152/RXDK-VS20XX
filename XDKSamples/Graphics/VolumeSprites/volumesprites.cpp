...
class CXBoxSample : public CXBApplication
{
    ...
    HRESULT RenderParticleSystem( D3DBaseTexture* pTexture );
...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\PSprite.xvu",
                                           dwVertexDecl,
                                           &m_dwVertexShader ) ) )
        return XBAPPERR_MEDIANOTFOUND;
...
HRESULT CXBoxSample::Render()
{
    ...
    m_pd3dDevice->SetRenderState( D3DRS_BLENDCOLOR, 0xff000000 );
    RenderParticleSystem( m_pVolumeTexture );

    // Draw reflection of particles
    m_pd3dDevice->SetTransform( D3DTS_VIEW, &m_matReflectedView );
    m_pd3dDevice->SetRenderState( D3DRS_BLENDCOLOR, 0x40000000 );
    RenderParticleSystem( m_pVolumeTexture );
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"VolumeSprites" );
...
//-----------------------------------------------------------------------------
HRESULT CXBoxSample::RenderParticleSystem( D3DBaseTexture* pTexture )
{
