...
//       to override the function, having it call a function in your app
...
#ifndef LTCG
    // There is not an instrumented LTCG version of D3D8, so LTCG profiling is not supported.
    D3DPERF_Reset();
...
//       default, dumps similar information to the debug port.)
//-----------------------------------------------------------------------------
VOID GetPerfStatistics()
{
#ifndef LTCG
    ...
    // Get time (in microseconds), number of frames, and frame rate
...
VOID PerfTestCallback()
{
    ...
    // indefinitely or, as we use it here, treat it as a one-shot deal.
    StopPerfTest();
...
//       to the debug port. We mimic it here to demonstrate the use of the user-
