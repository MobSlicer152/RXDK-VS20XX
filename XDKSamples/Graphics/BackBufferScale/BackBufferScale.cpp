...
//       this is a technique that could be useful for fill bound apps that are
//       willing to sacrifice quality in order to maintain frame rate.
//
//       To prevent tearing, note that the rendering device is created with
//       two back buffers. After rendering a scene, the backbuffer is scaled and
            ...
            :CXBApplication()
{
    ...
    // To prevent tearing, use 2 back buffers
...
HRESULT CXBoxSample::Render()
{
    ...
    // scale.
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"BackBufferScale" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );
        m_Font.DrawText( 592, 38, 0xffcccc00, m_strFrameRate, XBFONT_RIGHT );
