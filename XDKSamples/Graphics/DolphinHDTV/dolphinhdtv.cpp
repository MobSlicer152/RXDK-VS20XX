...
{
    { XBHELP_A_BUTTON,     XBHELP_PLACEMENT_2, L"Next video\nmode" },
...
CXBoxSample::CXBoxSample()
            :CXBApplication()
{
    // Find out which HDTV modes (and/or widescreen) the user has
    // enabled in the Xbox Dashboard
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( fBorderX, fBorderY, 0xffffffff, L"DolphinHDTV " );
        m_Font.SetScaleFactors( 1.0f, 1.0f );
        m_Font.DrawText( g_aDisplayModes[ m_dwCurrentMode ].dwWidth - fBorderX - 120.0f, fBorderY, 0xffffff00, m_strFrameRate );
