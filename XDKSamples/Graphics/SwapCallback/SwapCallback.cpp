...
HRESULT CXBoxSample::Initialize()
{
    ...
    // Set a swap callback to regulate frame rate
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"SwapCallback" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );
        m_Font.DrawText( 592, 38, 0xffffff00, m_strFrameRate, XBFONT_RIGHT );

        WCHAR str[80];
        m_Font.DrawText(  64, 80, 0xffffffff, L"Time until VBlank:" );
        ...
        if( g_dwNumMissedVBlanks > 0 )
        {
            ...
            m_Font.DrawText( 255,  80, 0xffff0000, str );
        ...
        else
        {
            ...
            m_Font.DrawText( 255, 80, 0xffffff00, str );
        }
    }
