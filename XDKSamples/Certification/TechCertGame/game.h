...
class Game
{
    ...
    LPDIRECT3DTEXTURE8 m_pScreenShotTexture;    // For saved games
...
public:
    ...
    Game( CXBFont*, AudioEngine&, CSoundEffect& );

    // Begin new game
    VOID    Start( BOOL bRecordDemo, BOOL bPlayDemo, BOOL bIsVibrationOn, FLOAT fMusicVolume, FLOAT fEffectVolume, UINT uSelectedSoundtrack,
