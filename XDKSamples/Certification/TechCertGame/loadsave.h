...
private:
    ...
    struct StorageDev : public CXBStorageDevice
    {
        ...
        WCHAR strTotalBlocks[ MAX_BLOCKS_STR ];   // Formatted total blocks string
        WCHAR strFreeBlocks[ MAX_BLOCKS_STR ];    // Formatted free blocks string
    ...
    mutable CXBFont   m_BigFont;      // Big font
    mutable CXBFont   m_MedFont;      // Medium font
    mutable CXBFont   m_SmallFont;    // Smaller font
    mutable CXBFont   m_ButtonFont;   // Font buttons
    ...
    SavedGameIndex    m_iTopGame;          // Top most game visible on screen
    ...
    LPDIRECT3DVERTEXBUFFER8     m_pBackgroundVB;      // Quad for background
    LPDIRECT3DTEXTURE8          m_pBackgroundTexture; // Texture for background
    LPDIRECT3DTEXTURE8          m_pMsgBoxTexture;     // Message Box texture
    LPDIRECT3DTEXTURE8          m_pPlainBackTexture;  // Plain background

    LPDIRECT3DTEXTURE8 m_pXboxTexture;      // Xbox graphic
    LPDIRECT3DTEXTURE8 m_pMUTexture;        // MU graphic
    LPDIRECT3DTEXTURE8 m_pWideMUTexture;    // Wide MU Graphic
    LPDIRECT3DTEXTURE8 m_pXboxSelTexture;   // Xbox selection background
    LPDIRECT3DTEXTURE8 m_pMUSelTexture;     // MU selection background
    LPDIRECT3DTEXTURE8 m_pUpTexture;        // Up arrow
    LPDIRECT3DTEXTURE8 m_pDownTexture;      // Down arrow
    LPDIRECT3DTEXTURE8 m_pMUBadTexture;     // Corrupt MU graphic

    LPDIRECT3DTEXTURE8 m_pGameImageTexture; // Save game image
...
private:
    ...
    static BOOL GetSignature( const BYTE*, DWORD, VOID* );
...
#endif // TECHCERTGAME_LOAD_SAVE_H
