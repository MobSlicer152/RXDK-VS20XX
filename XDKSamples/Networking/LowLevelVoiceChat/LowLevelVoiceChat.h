...
class CXBoxSample : public CXBApplication
{
    ...
    BOOL         m_bLoopback;            // Loopback toggle
    BOOL         m_bVoiceThroughSpeakers;   // Voice through speakers
...
private:
    ...
    // Handle keep-alive
    HRESULT OnPlayerJoined( const WCHAR* strName, XNADDR xnAddr, in_addr* pinAddr );
