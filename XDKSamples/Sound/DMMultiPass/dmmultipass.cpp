...
XBHELP_CALLOUT g_HelpCallouts[] = 
{
    ...
    { XBHELP_START_BUTTON, XBHELP_PLACEMENT_2, L"Toggle\nheadphones" },
...
class CXBoxSample : public CXBApplication
{
    ...
    FLOAT                       m_fVolume[NUM_SOUNDS];      // Current volume
...
HRESULT CXBoxSample::Initialize()
{
    ...
    m_apSegStates[m_dwCurrent]->SetVolume( (LONG)m_fVolume[m_dwCurrent], 0 );
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff, L"DMMultiPass" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );

        // Show status
        swprintf( strBuffer, L"%s %s", g_strFileNames[m_dwCurrent], m_bLooping[m_dwCurrent] ? L"(Looping)" : L"" );
        m_Font.DrawText( 64, 100, 0xffffffff, L"Current Sound: " );
        m_Font.DrawText( m_bPlaying[m_dwCurrent] ? 0xffffff00 : 0xff808000, strBuffer );
